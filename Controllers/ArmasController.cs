...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://www.lucasns06.somee.com/rpgapi/Armas/";
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    if (!perfil.Equals("Admin"))
                    {
                        ...
                        foreach (ArmaViewModel av in listaArmas)
                        {
                            ...
                            string uriBuscaPersonagens = $"http://www.lucasns06.somee.com/rpgapi/Personagens/{av.PersonagemId}";

                            HttpResponseMessage responsePersonagens = await httpClient.GetAsync(uriBuscaPersonagens);
                            
                            if (responsePersonagens.StatusCode == System.Net.HttpStatusCode.OK)
                            {
                                ...
                                if (personagem.UsuarioId == usuarioId)
                                    avm.Add(av);
                            }
                        }
                        listaArmas = avm;
        ...
        public async Task<ActionResult> CreateAsync(int? id)
        {
            try
            {
                ...
                string perfil = HttpContext.Session.GetString("SessionPerfilUsuario");
                string uriBuscaPersonagens = (perfil == "Admin") ? "http://www.lucasns06.somee.com/rpgapi/Personagens/GetAll" : $"http://www.lucasns06.somee.com/rpgapi/Personagens/GetByPerfil/{usuarioId}";
